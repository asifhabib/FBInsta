...
class InstagramApi {
    ...
    private let instagramAppID = "572827910585092"
    
    private let redirectURIURLEncoded = "https://www.purelogics.net/"
    
    private let redirectURI = "https://www.purelogics.net/"
    
    private let app_secret = "ef8da03a5bd563c2c8f706a1f13924d7"
    ...
    private func getMediaData(testUserData: InstagramTestUser, completion: @escaping (Feed) -> Void) {
        let urlString = "\(BaseURL.graphApi.rawValue)me/media?fields=id,caption,media_url&access_token=\(testUserData.access_token)"
